                ...
                <div className="relative z-10 pt-16 md:pt-24 pb-12 md:pb-16">
                    ...
                    >
                        <div className="relative flex flex-col items-center space-y-2">
                            ...
                            <h2 className="font-samarn text-3xl md:text-4xl lg:text-5xl font-light tracking-tight text-[#132b15] pb-6">
                                A Legacy of Healing
                            </h2>
                            <div className="w-[70%] h-0.5 bg-[#680007]/20"></div>
                        </div>
                        <p className="font-serif text-3xl text-[#132b15]/70 leading-relaxed max-w-3xl mt-16">
                ...
                >
                    <div className="max-w-lg mx-auto py-2 px-6 mb-4 bg-[#faf8f5]/80 backdrop-blur-md border border-[#680007]/10 rounded-full shadow-2xl flex items-center justify-center space-x-8">
                        ...
                        <StyledButton
                            ...
                            variant="secondary"
                            className="flex-1 border-2 border-[#680007] !text-xs text-[#680007] hover:text-[#faf8f5]"
                        >
